...
const MSG = {
  ...
  con_imageAdd: { en: "Add image (PNG/JPEG, up to 10 MiB)", zh_CN: "添加图片（PNG/JPEG，最大 10 MiB）", zh_TW: "新增圖片（PNG/JPEG，最大 10 MiB）" },
  con_imageRemove: { en: "Remove image: {0}", zh_CN: "移除图片：{0}", zh_TW: "移除圖片：{0}" },
  con_imageAdded: { en: "Image attached: {0}", zh_CN: "已附加图片：{0}", zh_TW: "已附加圖片：{0}" },
  con_imageRemoved: { en: "Image removed", zh_CN: "已移除图片", zh_TW: "已移除圖片" },
  con_imageType: { en: "Only PNG/JPEG images are supported", zh_CN: "仅支持 PNG/JPEG 图片", zh_TW: "僅支援 PNG/JPEG 圖片" },
  con_imageSize: { en: "Image must be 10 MiB or smaller", zh_CN: "图片必须小于或等于 10 MiB", zh_TW: "圖片必須小於或等於 10 MiB" },
  con_imageRead: { en: "Could not read the image — choose it again", zh_CN: "读取图片失败，请重新选择", zh_TW: "讀取圖片失敗，請重新選擇" },
