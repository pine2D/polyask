...
export const BACKUP_KINDS = ["history", "archive", "decision", "folder", "folderMembership", "template", "group", "workspace", "question", "questionAnswer"] as const;
...
export type BackupNote = "question_new_identity" | "folder_new_identity" | "folder_reused" | "dependency_required";
